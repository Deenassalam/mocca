  ...
  <nav class="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase" id="mainNav" style="height: 80px;">
    ...
    <header class="masthead bg-primary text-white text-center">
      <div class="container">
        ...
        <h2 class="font-weight-light mb-0">BPBD</h2>
      </div>
    </header>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-2">
            <a class="portfolio-item d-block mx-auto" href="{{ route('apajalah') }}">
          ...
          </div><div class="col-md-6 col-lg-2" style="justify-content: center; font-family: Palatino Linotype; font-size: 18px; margin-left: -20px; margin-top: 25px;"> Laporan</div> 
          </a>
          <div class="col-md-6 col-lg-2">
            <a class="portfolio-item d-block mx-auto" href="{{ route('tambahbencana') }}">
              <div class="portfolio-item-caption d-flex position-absolute h-100 w-100">
                <div class="portfolio-item-caption-content my-auto w-100 text-center text-white">
          ...
          </div><div class="col-md-6 col-lg-2" style="justify-content: center; font-family: Palatino Linotype; font-size: 18px; margin-left: -20px; margin-top: 25px;"> Tambah Data Bencana</div>  </a>
          <div class="col-md-6 col-lg-2">
            <a class="portfolio-item d-block mx-auto" href="{{route('tambahkegiatan') }}">
              <div class="portfolio-item-caption d-flex position-absolute h-100 w-100">
                <div class="portfolio-item-caption-content my-auto w-100 text-center text-white">
                  <i class="fas fa-search-plus fa-3x"></i>
                </div>
          ...
          </div><div class="col-md-6 col-lg-2" style="justify-content: center; font-family: Palatino Linotype; font-size: 18px; margin-left: -20px; margin-top: 25px;"> Agendakan Kegiatan</div>  </a>
        </div>
      </div>
