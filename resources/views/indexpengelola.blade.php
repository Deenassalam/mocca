  ...
  <body id="page-top">
    ...
    <header class="masthead bg-primary text-white text-center">
      <div class="container">
        ...
        <h2 class="font-weight-light mb-0">FKKRS</h2>
      </div>
    </header>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-2">
            <a class="portfolio-item d-block mx-auto" href="{{ route('kelolakomunitas') }}">
          ...
          <div class="col-md-6 col-lg-2" style="justify-content: center; font-family: Palatino Linotype; font-size: 18px; margin-left: -20px; margin-top: 25px;"> Kelola Data Komunitas</div> 
          </a>
          <div class="col-md-6 col-lg-2">
          ...
          <div class="col-md-6 col-lg-2">
          <a class="portfolio-item d-block mx-auto" href="{{ route('kelolarelawan') }}">
              <div class="portfolio-item-caption d-flex position-absolute h-100 w-100">
                <div class="portfolio-item-caption-content my-auto w-100 text-center text-white">
                </div>
              </div>
          ...
          </div><div class="col-md-6 col-lg-2" style="justify-content: center; font-family: Palatino Linotype; font-size: 18px; margin-left: -20px; margin-top: 25px;"> Kelola Data Relawan</div> 
          </a>
    </section>
    </br>
</br>
