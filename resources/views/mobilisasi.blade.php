...
?>
        ...
        @foreach($data as $datas)
            <form action="{{ route('lapKom.store') }}" method="POST">
                {{ csrf_field() }}
                <div class="form-group">
                    <label for="id_benc">ID Laporan:</label>
                    <input name="id_benc" readonly="true">{{ $datas->id_benc }}</input>
                </div>
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <label for="lokasi">Pilih Komunitas: </label>
                    <select name="id_kom">
                      @foreach($komunitas as $datass)
                      <option value="{{ $datass->id_kom }}">{{ $datass->id_kom }} - {{$datass->nama_kom }}</option>
                      @endforeach
                    </select>
                </div>
                <div class="form-group">
